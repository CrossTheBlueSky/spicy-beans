...
~~~~~~~~~~LOGICAL BREAKDOWN~~~~~~~~~~~~~~~
    ...
    1. So I'm given the node but not the linked list? So updating the pointer to skip the input node won't work
    2. Okay, I can get fiddly with it by just making the current node equal to following node
    3. Then I should be able to unlick the copied node the same way I would normally unlink a node
    */
